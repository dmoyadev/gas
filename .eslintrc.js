module.exports = {
	...
	env: { node: true }, // Specifies the Node.js environment for linting.

	extends: [
		'plugin:vue/vue3-recommended', // Use the recommended rules from the @vue/eslint-config-recommended plugin.
		'eslint:recommended', // Use the recommended rules from ESLint.
		'@vue/typescript/recommended', // Use the recommended rules from the @vue/eslint-config-typescript plugin.
	],
