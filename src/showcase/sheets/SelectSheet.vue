...
const items = ref<{ id: number | string; name: string; icon: string }[]>([
	{ id: 1, name: 'Item 1', icon: 'fa-solid fa-car' },
	{ id: 2, name: 'Item 2', icon: 'fa-solid fa-gauge' },
	{ id: 3, name: 'Item 3', icon: 'fa-solid fa-gear' },
	{ id: 4, name: 'Item 4', icon: 'fa-solid fa-gas-pump' },
	{ id: 5, name: 'Item 5', icon: 'fa-solid fa-search' },
]);
